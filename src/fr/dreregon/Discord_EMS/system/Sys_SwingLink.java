...
public class Sys_SwingLink extends JLabel {
   ...
   */
  public Sys_SwingLink(String text, String uri) {
   ...
   * Constructs a SwingLink with the given text that will launch the given URI when clicked.
   */
  public Sys_SwingLink(String text, URI uri) {
    super(text);
    setLink(uri);
  ...
  public static void open(URI uri) {
    if (Desktop.isDesktopSupported()) {
      ...
      try {
        ...
        Sys_Message.main("Failed to open " + uri + " - your computer is likely misconfigured.\n" +
            "Error Message: " + e.getMessage(), Sys_MsgType.WARN);
      }
    } else {
      Sys_Message.main("Java is not able to open a browser on your computer.", Sys_MsgType.WARN);
    }
  }

  private enum LinkStyle {
    UNVISITED(new Color(114, 137, 218), true),
    ACTIVE(new Color(153, 170, 181), false),
    VISITED(new Color(30, 33, 36), true);
